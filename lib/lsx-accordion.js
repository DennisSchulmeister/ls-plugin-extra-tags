...
class LSX_Accordion {
    ...
    preprocessHtml(html, jqHtml, utils, plugin) {
        ...
        lsxAccordionElements.forEach(lsxAccordionElement => {
            ...
            let lsxAccordionPageElements = lsxAccordionElement.querySelectorAll("lsx-accordion-page");
            let pageNumber = 0;
            ...
            lsxAccordionPageElements.forEach(lsxAccordionPageElement => {
                ...
                let lsxTitleElement = lsxAccordionPageElement.querySelector("lsx-accordion-title");
                ...
                let lsxContentElement = lsxAccordionPageElement.querySelector("lsx-accordion-content");
