...
class LSX_Quiz {
    ...
    preprocessHtml(html, jqHtml, utils, plugin) {
        this._countQuizContents(html, jqHtml, utils, plugin);

        this._render_lsx_quiz(html, jqHtml, utils, plugin);
        this._render_lsx_exercise(html, jqHtml, utils, plugin);
        this._render_lsx_question(html, jqHtml, utils, plugin);
        this._render_lsx_answer(html, jqHtml, utils, plugin);
        this._render_lsx_hint(html, jqHtml, utils, plugin);
    }
     ...
     * @param {Object} plugin Plugin main object
     */
    _countQuizContents(html, jqHtml, utils, plugin) {
        let quizNumber = 0;
        ...
        html.querySelectorAll("lsx-quiz").forEach(lsxQuizElement => {
            ...
            lsxQuizElement.querySelectorAll("lsx-exercise").forEach(lsxExerciseElement => {
                lsxExerciseElement.dataset.quiz = quizNumber;
                lsxExerciseElement.dataset.exercise = ++exerciseNumber;
                let questionNumber = 0;

                lsxExerciseElement.querySelectorAll("lsx-question").forEach(lsxQuestionElement => {
                    ...
                    lsxQuestionElement.querySelectorAll("lsx-answer").forEach(lsxAnswerElement => {
     ...
     * @param {Object} plugin Plugin main object
     */
    _render_lsx_quiz(html, jqHtml, utils, plugin) {
     ...
     * @param {Object} plugin Plugin main object
     */
    _render_lsx_exercise(html, jqHtml, utils, plugin) {
        ...
        lsxElements.forEach(lsxElement => {
            ...
            let quizCorrectionElement = $.parseHTML($.trim(`
                <div
            ...
            let quizExerciseElement = $.parseHTML($.trim(`
                <div
     ...
     * @param {Object} plugin Plugin main object
     */
    _render_lsx_question(html, jqHtml, utils, plugin) {
        ...
        lsxElements.forEach(lsxElement => {
            ...
            let quizQuestionElement = $.parseHTML($.trim(`
                <div
    ...
    /**
     * Replace all <lsx-answer-select> with their HTML counterpart.
     *
     * Input:
     *
     ...
     * @param {Object} plugin Plugin main object
     */
    _render_lsx_answer(html, jqHtml, utils, plugin) {
        ...
        lsxElements.forEach(lsxElement => {
            ...
            if (lsxElement.dataset.type.toLowerCase() === "multiple-choice") {
                ...
                iconUnchecked = "icon-radio-unchecked";
                iconChecked   = "icon-radio-checked2";
            }
            ...
            let quizSelectElement = $.parseHTML($.trim(`
                <div
            ...
            let quizTextElement = $.parseHTML($.trim(`
                <div
     ...
     * @param {Object} plugin Plugin main object
     */
    _render_lsx_hint(html, jqHtml, utils, plugin) {
        ...
        lsxElements.forEach(lsxElement => {
            ...
            let quizHintElement = $.parseHTML($.trim(`
    ...
    _onAnswerCheckHover(event, hovering) {
        ...
        let elements = document.querySelectorAll($.trim(`
    ...
    _onAnswerCheckClick(event) {
        ...
        let sameAnswerElements = document.querySelectorAll($.trim(`
            .lsx-quiz-answer-select[data-quiz='${quiz}'][data-exercise='${exercise}'][data-question='${question}'][data-answer='${answer}'],
            .lsx-quiz-answer-text[data-quiz='${quiz}'][data-exercise='${exercise}'][data-question='${question}'][data-answer='${answer}']
        `));

        let otherAnswerElements = document.querySelectorAll($.trim(`
    ...
    _onCorrectionScoreUpdate(event, actualPointsElement, maxPointsElement, totalPercentageElement) {
        ...
        if (totalPercentageElement) {
            ...
            totalPercentageElement.textContent = `${numberFormat.format(totalPercentageElement.dataset.value)}%`;
        }
    }
    ...
    _updateStatusIcon(element) {
        ...
        if (status == "correct" && points) {
            ...
            iconElement.classList.add("icon-checkmark2");
