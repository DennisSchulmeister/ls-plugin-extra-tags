 ...
 */
export default class LSX_Youtube {
    /**
    ...
    preprocessHtml(html, plugin) {
        ...
        lsxElements.forEach(lsxElement => {
            ...
            // But we keep it for lecture-slides.js compatibility, as there a default
            // margin is set based on that class.
            let newElement = parseHtml(`
                <div class="embed-responsive ratio ratio-${aspectRatio}">
                    <iframe src="https://www.youtube-nocookie.com/embed/${videoId}?rel=0&amp;showinfo=0" allow="fullscreen"></iframe>
                </div>
            `)[0];
