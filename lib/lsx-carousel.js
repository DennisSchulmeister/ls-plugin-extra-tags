        ...
        lsxCarouselElements.forEach(lsxCarouselElement => {
            ...
            let newCarouselElement = $.parseHTML($.trim(`
                <div class="carousel-outer">
                    ...
                    <div id="${id}-items" class="carousel slide" data-interval="false">
            ...
            let lsxCarouselPageElements = lsxCarouselElement.querySelectorAll("lsx-carousel-page");
            let pageNumber = -1;
            ...
            lsxCarouselPageElements.forEach(lsxCarouselPageElement => {
                ...
                pageNumber += 1;
                if (pageNumber === 1) newCarouselPageElement.classList.add("active");
